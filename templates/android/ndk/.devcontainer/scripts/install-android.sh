...
CMD_LINE_TOOLS_VERSION="7302050_latest"
...
echo "Instalando platform-tools, NDK, platforms, build-tools y cmake..."
...
yes | sdkmanager --sdk_root="${ANDROID_SDK_ROOT}" --install "cmake;${CMAKE_VERSION}"

rm -rf "$TMP_DIR"

echo "Android SDK + NDK instalado correctamente en ${ANDROID_SDK_ROOT}"
